...
class StsEditHomeTopImg
{
    ...
    /**
     * Metodo para pesquisar a imagem do top da home que será editada
     * @return boolean
     */
    public function viewHomeTopImg(): bool
    {
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Erro: Image home top não encontrada!</p>";
            $this->result = false;
            return false;
        }
    }
    ...
    private function deleteImage(): void
    {
        if (((!empty($this->resultBd[0]['image_top'])) or ($this->resultBd[0]['image_top'] != null)) and ($this->resultBd[0]['image_top'] != $this->nameImg)) {
            $this->delImg = "app/sts/assets/images/home_top/" . $this->resultBd[0]['image_top'];
