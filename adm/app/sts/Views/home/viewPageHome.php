            ...
            ?>
                ...
                <div class="view-det-adm">
                    ...
                    <span class="view-adm-info">
                        <?php
                        if ((!empty($image_top)) and (file_exists("app/sts/assets/images/home_top/$image_top"))) {
                            echo "<img src='" . URLADM . "app/sts/assets/images/home_top/$image_top' width='250'><br><br>";
                        } else {
                            echo "<img src='" . URLADM . "app/sts/assets/images/home_top/icon_home_top.jpg' width='250'><br><br>";
                        }
                        ?>
                    </span>
                </div>
        ...
        <div class="content-adm">
            ...
            ?>
                ...
                <div class="view-det-adm">
                    ...
                    <span class="view-adm-info">
                        <?php
                        if ((!empty($prem_image)) and (file_exists("app/sts/assets/images/home_prem/$prem_image"))) {
                            echo "<img src='" . URLADM . "app/sts/assets/images/home_prem/$prem_image' width='250'><br><br>";
                        } else {
                            echo "<img src='" . URLADM . "app/sts/assets/images/home_prem/icon_premium_serv.jpg' width='250'><br><br>";
                        }
                        ?>
                    </span>
                </div>
