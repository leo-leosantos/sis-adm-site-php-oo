...
class CarregarPgAdm
{
    ...
    private function loadClassSts(): void
    {
        ...
        if (class_exists($this->classLoad)) {
            ...
            die("Erro - 007: Por favor tente novamente. loadclassSts linha 63 Carregar pag" . EMAILADM);
            /*$this->urlController = $this->slugController(CONTROLLER);
            $this->urlMetodo = $this->slugMetodo(METODO);
            $this->urlParameter = "";
            $this->loadPage($this->urlController, $this->urlMetodo, $this->urlParameter);*/
...
/**
    ...
    private function pgPrivate():void
    {
        ...
        "EditUsers", "EditUsersPassword", "EditUsersImage", "DeleteUsers", 
